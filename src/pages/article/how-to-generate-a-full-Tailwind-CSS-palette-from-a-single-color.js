        ...
        extend: {
            colors: {
                ...
                <div className="absolute bg-white flex justify-around bottom-0 right-0">
                    ...
                    <Link to="/article/unexpected-benefits-of-estimations/" className="inline-block p-6 text-e6n-black hover:text-e6n-blue focus:outline-none" title="Unexpected benefits of estimations">
