        ...
        <Layout>
            ...
            <div className="relative h-full w-full bg-e6n-black light-mode:bg-white">
                ...
                <div className="absolute bg-white flex justify-around bottom-0 right-0">
                    ...
                    <Link to="/article/100-lines-of-code-per-file/" className="inline-block p-6 text-e6n-black hover:text-e6n-blue focus:outline-none" title="100 lines of code per file">
