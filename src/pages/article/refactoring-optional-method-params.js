...
`class PageRepository
{
    ...
    ...
                ...
                <div className="absolute bg-white flex justify-around bottom-0 right-0">
                    ...
                    <Link to="/article/why-wrapping-3rd-party-calls-to-external-service-is-always-a-good-idea/" className="inline-block p-6 text-e6n-black hover:text-e6n-blue focus:outline-none" title="Why wrapping 3rd-party calls to external services is always a good idea">
